...
@interface MLSoCoolViewController () <ESTBeaconManagerDelegate>{
...
@implementation MLSoCoolViewController
...
- (void)beaconManager:(ESTBeaconManager *)manager didRangeBeacons:(NSArray *)beacons inRegion:(ESTBeaconRegion *)region
{
    if (beacons.count > 0)
    {
       ...
       // [self textForProximity:firstBeacon.proximity];
        [self createSomethingCool:[self textForProximity:firstBeacon.proximity :firstBeacon.distance]];
...
- (NSString *)textForProximity:(CLProximity)proximity :(NSNumber*)distance
{
